...
def _make_coilset(n_unique_coils: int, fourier_order: int) -> types.Coilset:
...
def test_round_trip():
    ...
    desc_cs = coilset_utils.coilstellaration_to_desc(original)
    result = coilset_utils.coilstellaration_from_desc(
