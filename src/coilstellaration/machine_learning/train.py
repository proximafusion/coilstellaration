...
import wandb
from coilstellaration import coilset_utils, data_utils, flax_nnx_checkpoint_util, types
...
def train(
    ...
    train_df = data_utils.load_ml_baseline_dataframe(
        "train",
    )
    eval_df = data_utils.load_ml_baseline_dataframe(
        "eval",
    )
